...
namespace AAgOpenGPS.Android
{
    public partial class Main
    {
       ...
       // public List<CFlag> flagPts = new List<CFlag>(); hennie
        ...
        public double camSmoothFactor = 0.0; //hennie
        ...
        public void UpdateFixPosition()
        {
                ...
                case "Fix":
                    {
                        ...
                        if (Properties.Settings.Default.setGPS_headingFromWhichSource == "Dual" && ahrs.autoSwitchDualFixOn)
                        {
                           // lblSpeed.ForeColor = System.Drawing.Color.Red; TODO
                        }
                        ...
                        if (!isFirstHeadingSet) //set in steer settings, Stanley
                        {
                            ...
                            if (stepFixPts[2].isSet == 0)
                            {
                               ...
                               // TimedMessageBox(2000, "Direction Reset", "Forward is Set"); hennie
                               Console.WriteLine("Direction Reset" + "Forward is Set");
                ...
                case "Dual":
                    {
                        if (Properties.Settings.Default.setGPS_headingFromWhichSource == "Dual" && ahrs.autoSwitchDualFixOn)
                        {
                           // lblSpeed.ForeColor = System.Drawing.Color.Green; TODO
                            isChangingDirection = false;
                        }
            ...
            if (!vehicle.isInFreeDriveMode)
            {
                ...
                if (!timerSim.IsEnabled)
                {
                    ...
                    {
                       // btnAutoSteer.PerformClick(); hennie
                       Console.WriteLine("btnAutoSteer.PerformClick");
                    }
                    ...
                    if (isBtnAutoSteerOn && avgSpeed < vehicle.minSteerSpeed)
                    {
                        ...
                        if (minSteerSpeedTimer > 80)
                        {
                            ...
                            if (isMetric)
                              ...
                              Console.WriteLine("AutoSteer Disabled" + "Below Minimum Safe Steering Speed");
                            else
        ...
        private void InitializeFirstFewGPSPositions()
        {
            ...
            else
            {
                ...
                if (isGPSPositionInitialized)
                {
                  ...
                  //  isDayTime = (DateTime.Now.Ticks < sunset.Ticks && DateTime.Now.Ticks > sunrise.Ticks);TODO
