...
namespace AAgOpenGPS.Android
{
    public class CContour
    {
        ...
        //private readonly FormGPS mf; hennei
        ...
        //constructor
        public CContour(Main _f) //hennie
        {
            mf = _f;
            ctList.Capacity = 128;
            ptList.Capacity = 128;
        ...
        public bool SetLockToLine()
        {
           ...
           // mf.SetContourLockImage(isLocked); hennei
            return isLocked;
        }
        ...
        public void BuildContourGuidanceLine(vec3 pivot)
        {
            ...
            if (!isLocked)
            {
                ...
                if (stripNum < 0 || minDistance > toolContourDistance || stripList[stripNum].Count < 4)
                {
                    ...
                    ctList.Clear();
                    isLocked = false;
                   // mf.SetContourLockImage(isLocked); hennie
                    return;
                }
            }
        ...
        public void StopContourLine()
        {
            ...
            if (ptList.Count > 5)
            {
               ...
               // mf.contourSaveList.Add(ptList); hennie
