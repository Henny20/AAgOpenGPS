        ...
        public void UpdatePosition()
        {
            ...
            if (isFollowingRecPath)
            {
                ...
                if (!isEndOfTheRecLine)
                {
                    ...
                    bool autoBtn = (mf.autoBtnState == Main.btnStates.Auto); //TODO
                    trig = autoBtn;
                    if (autoBtn != recList[C].autoBtnState) Console.WriteLine("WTF"); //mf.btnSectionMasterAuto.PerformClick();TODO
                }
                else
                {
