...
//using AgOpenGPS.Core.Translations;TODO
                    ...
                    if (mf.trk.gArr[mf.trk.idx].mode <= TrackMode.Curve)
                    {
                        if (mf.isBtnAutoSteerOn && !mf.isReverse)
                        {
                            if (isHeadingSameWay)
                            {
                                ...
                                {
                                   // mf.AutoSteer.PerformClick(); TODO
                                  //  mf.TimedMessageBox(2000, gStr.gsGuidanceStopped, gStr.gsPastEndOfCurve); TODO
                            ...
                            else
                            {
                                ...
                                {
                                    //mf.btnAutoSteer.PerformClick(); TODO
                                    //mf.TimedMessageBox(2000, gStr.gsGuidanceStopped, gStr.gsPastEndOfCurve);  TODO
                                    Log.EventWriter("Autosteer Stop, Past End of Curve");
                                }
                            }
