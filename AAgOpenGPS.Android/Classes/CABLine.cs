...
using static AAgOpenGPS.RegisteredServices;
...
namespace AAgOpenGPS.Android
{
    public class CABLine
    {
        ...
        public bool isMakingABLine = true; //must have value
        ...
        public Line DrawABLineNew()
        {
            ...
            Line mLine = new Line();
            mLine.SetVerts((float)desLineEndA.easting, (float)desLineEndA.northing, 0.0f, (float)desLineEndB.easting, (float)desLineEndB.northing, 0.0f);
            mLine.SetColor(0.95f, 0.70f, 0.50f, 1.0f);
