...
//using System.Drawing; only Windows
using System.Net;
using System.Net.Sockets;
//using System.Windows.Forms; not available
...
namespace AAgOpenGPS.Android
{
    public partial class Main
    {
                ...
                switch (data[3])
                {
                    case 0xD6:
                        {
                            ...
                            {
                                if (timerSim.IsEnabled) DisableSim();
                    ...
                    case 221: // DD
                        {                    
                            ...
                            {
                                //lblHardwareMessage.Text = System.Text.Encoding.UTF8.GetString(data, 7, data[4] - 2); TODO
                               // lblHardwareMessage.IsVisible = true; TODO
                                hardwareLineCounter = data[5] * 10;

                                Log.EventWriter("iets" /*lblHardwareMessage.Text*/);

                                //color based on byte 6
                               // lblHardwareMessage.BackColor = data[6] == 0 ? Color.Salmon : Color.Bisque; TODO
                               // lblHardwareMessage.ForeColor = Color.Black; TODO
                            }
                            else
                            {
                               // lblHardwareMessage.Visible = false; TODO
                    ...
                    case 222: // 0xDE
                        {
                            ...
                            {
                                if ((data[6] & 1) != 1) { Console.WriteLine("hoera"); /*btnCycleLines.PerformClick();*/ }
                                if ((data[6] & 1) == 1) { Console.WriteLine("hoera"); /*btnCycleLinesBk.PerformClick();*/ }
                            }
                    ...
                    case 234://MTZ8302 Feb 2020
                        {
                           ...
                           // DoRemoteSwitches(); TODO sections.Designer.cs
        ...
        public void StartLoopbackServer()
        {
            ...
            {
               // MessageBox.Show("Load Error: " + ex.Message, "UDP Server", MessageBoxButtons.OK, MessageBoxIcon.Error); TODO
        ...
        private void DisableSim()
        {
            ...
            startCounter = 0;
           // panelSim.Visible = false; TODO
            timerSim.IsEnabled = false;
           // simulatorOnToolStripMenuItem.Checked = false; TODO
           // Properties.Settings.Default.setMenu_isSimulatorOn = simulatorOnToolStripMenuItem.Checked; TODO
          //  Properties.Settings.Default.Save(); TODO
            return;
        }

        private async void ReceiveAppData(IAsyncResult asyncResult)
        {
            try
            {
                // Receive all data
               ...
               // BeginInvoke((MethodInvoker)(() => ReceiveFromAgIO(localMsg)));
                 await Dispatcher.UIThread.InvokeAsync(() => { ReceiveFromAgIO(localMsg); });
            }
            catch (Exception)
            {
